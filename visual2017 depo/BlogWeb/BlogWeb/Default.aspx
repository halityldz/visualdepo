    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="GirisYap.aspx">ADMİN SAYFASI</a>
                </li>
                ...
                <asp:Repeater ID="Repeater2" runat="server">
                    <ItemTemplate>
                        ...
                        <div>
                            <ul>
                                <li>
                                    <asp:Label ID="Label7" runat="server" Text='<%#Eval("BASLIK") %>'></asp:Label><br />
                            <asp:Label ID="Label8" runat="server" Text='<%#Eval("ALTBASLIK") %>'></asp:Label><br />
                            <asp:Label ID="Label9" runat="server" Text='<%#Eval("ACIKLAMA") %>'></asp:Label><br />
                            <asp:Label ID="Label10" runat="server" Text='<%#Eval("TARIH") %>'></asp:Label><br />
                                </li>
                            </ul>
